...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        args = (
            raster_settings.bg, 
            raster_settings.render_indices,
            raster_settings.parent_indices,
            raster_settings.interpolation_weights,
            raster_settings.num_node_kids,
            means3D,
            colors_precomp,
            opacities,
            scales,
        ...
        num_rendered, color, radii,pixels, geomBuffer, binningBuffer, imgBuffer, invdepths, maxweight_indices = _C.rasterize_gaussians(*args)
        ...
        return color, radii, pixels, invdepths, maxweight_indices

    @staticmethod
    def backward(ctx, grad_out_color, no_grad_radii, _, grad_out_depth, no_grad_maxweight_indices):
        ...
        # 根据 depth_threshold 的值来决定是否缩放 grad_means2D
