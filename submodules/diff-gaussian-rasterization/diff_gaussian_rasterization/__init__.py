...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        args = (
            ...
            raster_settings.require_max_weight_indices,
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, coord, mcoord, alpha, normal, depth, mdepth, maxweight_indices, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, radii, coord, mcoord, depth, mdepth, alpha, normal, maxweight_indices

    @staticmethod
    def backward(ctx, grad_color, grad_radii, grad_coord, grad_mcoord, grad_depth, grad_mdepth, grad_alpha,grad_normal, no_grad_maxweight_indices):
...
class GaussianRasterizationSettings(NamedTuple):
    ...
    require_depth : bool
    require_coord : bool
    require_max_weight_indices : bool
    debug : bool
